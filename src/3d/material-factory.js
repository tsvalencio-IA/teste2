 ...
 * CORREÇÃO: Cores fiéis e THREE.DoubleSide ativado para visão interna.
 */
...
export const MatDefs = {
    ...
    // Cores Oficiais do Mercadão com Reflexo Laca
...
export const MaterialFactory = {
    ...
    getRealMaterial: (key) => {
        ...
        // MAGIA DO ESPAÇO OCO: Obriga o motor a pintar a madeira por dentro também
