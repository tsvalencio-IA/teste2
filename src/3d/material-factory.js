...
export const MatDefs = {
    ...
    'amadeirado_claro': { color: 0xD2B48C, roughness: 0.8, metalness: 0.0, label: "MDF Madeira Clara", mult: 1.2 }, 
    'louro_freijo': { color: 0x9E7A5A, roughness: 0.8, metalness: 0.0, label: "MDF Louro Freijó", mult: 1.3 },
    'carvalho_hanover': { color: 0x8A6343, roughness: 0.8, metalness: 0.0, label: "MDF Carvalho Hanover", mult: 1.3 },
    'nogueira_cadiz': { color: 0x5C4033, roughness: 0.85, metalness: 0.0, label: "MDF Nogueira Cádiz", mult: 1.3 },
    'tauari': { color: 0xBA8C63, roughness: 0.75, metalness: 0.0, label: "MDF Tauari", mult: 1.3 },
    'madeira_fuel': { color: 0x4a2e1b, roughness: 0.7, metalness: 0.05, label: "MDF Escuro / Fuel", mult: 1.1 },
    'mdf_branco_tx': { color: 0xFAFAFA, roughness: 0.9, metalness: 0.0, label: "MDF Branco Ártico TX", mult: 1.0 },
    'mdf_preto_tx': { color: 0x222222, roughness: 0.9, metalness: 0.0, label: "MDF Preto TX / Nero", mult: 1.0 },
    'mdf_grafite': { color: 0x424242, roughness: 0.7, metalness: 0.0, label: "MDF Grafite", mult: 1.0 },
    'mdf_cinza_sagrado': { color: 0x808080, roughness: 0.7, metalness: 0.0, label: "MDF Cinza Sagrado", mult: 1.0 },
    'mdf_azul_petroleo': { color: 0x153E5C, roughness: 0.8, metalness: 0.0, label: "MDF Azul Petróleo", mult: 1.4 },
    'mdf_verde_savia': { color: 0x556B2F, roughness: 0.8, metalness: 0.0, label: "MDF Verde Sálvia", mult: 1.4 },
